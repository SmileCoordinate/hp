...
const questions = {
   ...
   //3: 人との関わり方の改善、解消
   30: {
      text: "どうして、人との関わり方を改善、解消したいと思いますか？",
      options: {
         1: "職場や家族とのコミュニケーションがうまくできないと感じているから",
         2: "友達が少なくて友達を作りたいと思うから",
         3: "恋人との関係が上手くいっていないから",
         4: "私生活で生きづらさを感じているから",
         5: "その他"
      },
      next: (answer) => 31
   ...
   31: {
      text: "人と話すことは苦手だと感じる時はありますか？",
      options: {
         1: "話すことが好きで沢山話すことが多い",
         2: "話し上手だと思う",
         3: "そこそこ普通に話せる",
         4: "話すことが苦手だと思う",
         5: "話すことは苦手ではないが、共通の話題が見つからず、何を話したらよいか分からなくなり、話せないことがある",
         5: "分からない"
      },
      next: (answer) => 32
   },
   //質問32
   32: {
      text: "人の話を聞くことは苦手だと感じますか？",
      options: {
         1: "話を聞くことが好き",
         2: "聞き上手だと思う",
         3: "そこそこ話を聞いていられる",
         4: "聞くことが苦手だと思う",
         5: "話を聞くことは出来るが、興味や共感できないことだと苦痛に感じながら、聞き手になることが多い",
         6: "分からない"
      },
      next: (answer) => 33
   },
   //質問33
   33: {
      text: "あなたは、自分が思い込みや決めつけが多いと感じますか？",
      options: {
         1: "思い込みや決めつけることはしていないと思う",
         2: "物事に対して、思い込みや決めつけが多い",
         3: "思い込みは少ないと思う",
         4: "決めつけは少ないと思う"
      },
      next: (answer) => 34
   ...
   34: {
      text: "あなたは自分の思うとおりに、物事が運ばない時に何が思い浮かびますか？",
      options: {
         1: "最悪",
         2: "しょうがない、そんな時もある",
         3: "ま、大丈夫でしょ",
   ...
   //4: 子育て、教育のアドバイス
   41: {
      text: "どうして、子育てや教育のアドバイスが欲しいと思いますか？",
      options: {
         1: "自分の子どもにきちんとした教育をしたいから",
         2: "自分の子どもに対して接し方が分からないから",
         3: "家族や友人、親戚が子育てに苦戦していたから",
         4: "今のやり方で良いのか不安だから",
         5: "どうしたらいいのか分からないから",
         6: "その他"
      },
